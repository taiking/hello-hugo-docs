...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/hello-hugo-docs/flexsearch.min.js');loadScript('/hello-hugo-docs/en.search-data.min.de10fb9f82d9592aa7b5aa45a89b717b808f29e0e38831d3e48b036566f9b5e6.js',function(){input.required=false;search();});}
